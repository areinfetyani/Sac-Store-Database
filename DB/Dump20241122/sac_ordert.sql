...
CREATE TABLE `ordert` (
  ...
  PRIMARY KEY (`or_id`),
  KEY `cu_id` (`cu_id`),
  CONSTRAINT `ordert_ibfk_1` FOREIGN KEY (`cu_id`) REFERENCES `customer` (`c_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ordert` VALUES (1,1,'2024-01-29',100.00),(2,2,'2024-01-30',150.00),(3,3,'2024-02-01',200.00);
